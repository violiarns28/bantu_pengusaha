...
function edit(id) {
    ...
    $.ajax({
        type: "GET",
        url: uri + "/getonespesifik" ,
        data: { id: id },
        dataType: 'json',
        success: function(res) {
            console.log(res);
            $('#idspesifikedit').val(res['idspesifik']);
            $('#namaspesifikedit').val(res['namaspesifik']);
            $('#idareaedit').val(res['idarea']).change();
            selectElement('idareaedit',res['idarea']);
