...
var KTCreateAccount = function() {
    ...
    return {
        init: function() {
            ...
            r = new KTStepper(t), r.goTo(3), r.on("kt.stepper.changed", (function(e) {
            4 === r.getCurrentStepIndex() ? (o.classList.remove("d-none"), o.classList.add("d-inline-block"), a.classList.add("d-none")) : 5 === r.getCurrentStepIndex() ? (o.classList.add("d-none"), a.classList.add("d-none")) : (o.classList.remove("d-inline-block"), o.classList.remove("d-none"), a.classList.remove("d-none"))
               ...
               }else if(e.getCurrentStepIndex() == 1){
                    t ? t.validate().then((function(t) {
                            console.log("validated!"), "Valid" == t ? (
                                insertdw(), e.goNext() , gettgl()) : Swal.fire({  // insert(), insertdw(),
                            text: "Sorry, looks like there are some errors detected, please try again.",
                            icon: "error",
                            buttonsStyling: !1,
                            confirmButtonText: "Ok, got it!",
                ...
                fields: {
                    ...
                    'tgldw': {
                        validators: {
                            notEmpty: {
                                message: 'Tanggal denwancho harus diisi'
                            },
                        }
                    },
                    'spesifikdw[]': {
                        validators: {
                            notEmpty: {
                                message: 'spesifik area denwancho harus diisi'
                            },
                        }
                    },
                    'kategori[]': {
                        validators: {
                            notEmpty: {
                                message: 'kategori denwancho harus diisi'
                            },
                        }
                    },
                    'apd[]': {
                        validators: {
                            notEmpty: {
                                message: 'Apd dan alat kesehatan denwancho harus diisi'
                            },
                        }
                    },
                    'utility[]': {
                        validators: {
                            notEmpty: {
                                message: 'Utility denwancho harus diisi'
                            },
                        }
                    },
                    'peralatan[]': {
                        validators: {
                            notEmpty: {
                                message: 'Peralatan kerja harus diisi'
                            },
                        }
                    },
                    'planimg': {
                        validators: {
                            notEmpty: {
                                message: 'Visualisasi kerja harus diisi'
                            },
                        }
                    },
                    'listpekerja': {
                        validators: {
                            notEmpty: {
                                message: 'List pekerja harus diisi'
                            },
                            stringLength: {
                                min: 3,
                                message: 'List pekerja Harus ada',
                            },
                        }
                    },
                    'liststop6': {
                    ...
                    'listitemkerja': {
                        validators: {
                            notEmpty: {
                                message: 'List detail kerja harus diisi'
                            },
                            stringLength: {
                                min: 3,
                                message: 'List detail kerja Harus ada',
                            },
                        }
                    },
