//------------------------------ Validasi Modal Add User ---------------------------------------------
// Define form element
const form = document.getElementById('kt_modal_add_user');
    ...
    form,
    {
        fields: {
            ...
            'group_id': {
                validators: {
                    notEmpty: {
                        message: 'Group Role is required'
                    }
                }
            },
            'username': {
...
$('#buttonInsertUser').click(function(e) {
    e.preventDefault();
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            Swal.fire({
                ...
                const url = uri + "/deleteusernew/"+id;
                fetch(url, {
                    method : "GET",
                }).then(
                    response => response.text()// .json(), etc.
