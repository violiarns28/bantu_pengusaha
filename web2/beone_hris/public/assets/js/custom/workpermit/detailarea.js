                ...
                var o = FormValidation.formValidation(e, {
                    fields: {
                        namadtlx: {
                            validators: {
                                notEmpty: {
                                    message: "detail area name is required"
                                }
                            }
                        },
                        idspesifikx: {
                            validators: {
                                notEmpty: {
                                    message: "spesifik area name is required"
                                }
                            }
                        },
                    },
...
function edit(id) {
    ...
    $.ajax({
        type: "GET",
        url: uri + "/getonedetilarea" ,
        data: { id: id },
        dataType: 'json',
        success: function(res) {
            console.log(res);
            $('#iddtlareaedit').val(res['iddtlarea']);
            $('#namadtlareaedit').val(res['namadtlarea']);
            $('#idspesifikedit').val(res['idspesifik']).change();
            selectElement('idspesifikedit',res['idspesifik']);
                ...
                var o = FormValidation.formValidation(e, {
                    fields: {
                        ...
                        namadtlareaedit: {
                            validators: {
                                notEmpty: {
                                    message: "Area detail name is required"
                                }
                            }
                        },
                    },
