...
// Define form element
const form = document.getElementById('kt_modal_add_menu');
...
$('#buttonInsertMenu').click(function(e) {
    e.preventDefault();
...
if (validator) {
    ...
    const t = document.getElementById("kt_modal_add_menu");
    const i = t.querySelector('[data-kt-menu-modal-action="submit"]');
    const url = uri + "/insertmenu";
    fetch(url, {
        method : "POST",
        body: new FormData(document.getElementById("kt_modal_add_menu_form")),
    }).then(
        ...
        (result) => {
            ...
            const obj = JSON.parse(result); //success, message, code, icon
                Swal.fire({
                    ...
                    document.getElementById("kt_modal_add_menu_form").reset();
                    }
                }
                ))
        }
        ...
        (result) => {
            ...
            const obj = JSON.parse(result); //success, message, code, icon
                Swal.fire({
                    ...
                    confirmButtonText: "Ok, got it!",
                    customClass: {
                        confirmButton: "btn btn-custom-pruple"
                    }
                }).then((function(t) {
                    if(obj.success == true){
                    t.isConfirmed
