                ...
                var o = FormValidation.formValidation(e, {
                    fields: {
                        ...
                        isactivex: {
                            validators: {
                                notEmpty: {
                                    message: 'Active input is required'
                                }
                            }
                        },
                    },
...
function edit(id) {
    ...
    $.ajax({
        type: "GET",
        url: uri + "/getonevendor" ,
        data: { id: id },
        dataType: 'json',
        success: function(res) {
            console.log(res);
            $('#idperusahaany').val(res['idperusahaan']);
            $('#namaperushaany').val(res['namaperushaan']);
            $('#nomorperusahaany').val(res['nomorperusahaan']);
            if(res['isaktif'] == '1'){
                $('#isactivey').prop('checked', true);
            }
            $('#alamatperusahaany').val(res['alamatperusahaan']);
